...
const News = (number) => {
    ...
    const {data: cryptoNews } = useGetCryptoNewsQuery({ newsCategory , count : number.count});
    const {data: cryptosList, isFetching} = useGetCryptosQuery(number.count);
                        ...
                        <Card hoverable className="news-card">
                            <a href={news.url} target="_blank" rel="noreferrer">
                                <div className="news-image-container">
                                    ...
                                    <img id="image" src= {news?.image?.thumbnail?.contentUrl} alt="" />
                                </div>
                                ...
                                <div className="provider-container">
                                    <div>
                                        ...
                                        <Text className="provider">{news.provider[0]?.name}</Text>
                                    </div>
